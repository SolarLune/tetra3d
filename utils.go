...
// Renders src to dst blended with the given depth texture.
...
func RenderSrcToDestBlendedWithDepthTexture(dst, src, depth *ebiten.Image, rangeStart, rangeEnd float32, bayerMatrixDitherSize float32, transparencyCurve FogCurve) {
